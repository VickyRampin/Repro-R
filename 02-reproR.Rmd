...
renv::init(force=TRUE, restart = FALSE, prompt = FALSE)
```
...
The following figures were generated as a part of a submission to HICSS 2020 conference. We're going to try to run this code, and see if we can get all the dependencies with `renv`!
...
And that's it! Now if you send each other your R Projects with all the files and the `renv` lockfile, they will be able to reproduce your work :)
