...
Like I said, about 80-90% of reproducibility is adhering to best practices of RDM. Let's move over to talk about the best practice for reproducibility in particular for that last 20%!
...
> "Scientists' views of their fields as cooperative or competitive were associated with their normative perspectives, with competitive fields showing more counternormative behavior." -- Melissa S. Anderson, Brian C. Martinson, and Raymond De Vries, "[Normative Dissonance in Science: Results from a National Survey of U.s. Scientists](https://www.ncbi.nlm.nih.gov/pubmed/19385804)"
...
A few systems like Yale University Library’s [Emulation as a Service](http://guides.library.yale.edu/digitalpreservation/services) or Carnegie Mellon University's [Olive Archive](https://olivearchive.org/) offer legacy base operating system access to users that could in time start to address computational reproducibility as analysis software is added to their collections, or they integrate with existing tools like [Whole Tale]() or [ReproZip](https://reprozip.org).
...
> "Research compendia are an increasingly used form of publication, which packages not only the research paper's text and figures, but also all data and software for better reproducibility." - Nuest, Bottinger, & Marwick, [How to read a research compendium](https://arxiv.org/abs/1806.09525)
